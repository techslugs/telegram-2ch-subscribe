...
var SubscribeChannelCommand = Command{
	...
	ParseArguments: parseSubscribeChannelCommandArguments,
	HandleCommand:  handleSubscribeChannelCommand,
}

func parseSubscribeChannelCommandArguments(cmd *Command, messageText string) ([]string, bool) {
	args := cmd.Regexp.FindStringSubmatch(messageText)
	return args, len(args) > 2 && args[1] != "" && args[2] != ""
}

func handleSubscribeChannelCommand(
	cmd *Command,
