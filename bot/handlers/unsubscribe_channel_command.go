...
var UnsubscribeChannelCommand = Command{
	...
	ParseArguments: parseUnsubscribeChannelCommandArguments,
	HandleCommand:  handleUnsubscribeChannelCommand,
}

func parseUnsubscribeChannelCommandArguments(cmd *Command, messageText string) ([]string, bool) {
	args := cmd.Regexp.FindStringSubmatch(messageText)
	return args, len(args) > 2 && args[1] != ""
}

func handleUnsubscribeChannelCommand(
	cmd *Command,
